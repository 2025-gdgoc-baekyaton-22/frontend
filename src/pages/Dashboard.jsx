  ...
  return (
    <div className="dashboard-page">
      ...
      <div className="dashboard-container">
        ...
        <p className="body-text-4" style={{ color: "var(--gray-color-1)" }}>
        환자 건강 상태 보고서전반적인 신체 상태: MID배변/배뇨: 알 수 없음기분: MID사회적 활동: EXCELLENT약물 복용: VERY_GOOD식사: NO수면: NO인지: BAD병원 방문: YES관찰 사항: 환자는 인지적 어려움을 겪고 있습니다. 환자는 식사를 제대로 하지 않습니다. 환자는 수면에 어려움을 겪습니다.보호자를 위한 조언: 환자의 인지적 능력을 정기적으로 평가하고 필요한 경우 지원을 제공하세요. 환자가 규칙적이고 영양가 있는 식사를 하도록 도와주세요. 환자가 충분한 수면을 취할 수 있도록 지원하세요. 환자가 약물을 제대로 복용하고 있는지 확인하세요. 환자에게 감정적 지원을 제공하고, 필요에 따라 전문적인 도움을 받도록 권유하세요. 환자의 건강 상태에 대해 우려 사항이 있는 경우 의료 전문가와 상담하세요.
        </p>
      </div>
